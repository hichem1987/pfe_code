 ...
 */
class ONE_Attribute_Block_Catalog_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Type_Configurable{
    /**
    ...
    public function getJsonConfig(){
        ...
        $config = array_merge(
            ...
            array(
                ...
                'images'    => $images,
                'thumbs'    => $thumbs,
                'show'      => Mage::getStoreConfig('oneattribute/general/show'),
                'imgWidth'  => is_numeric(Mage::getStoreConfig('oneattribute/general/width'))?Mage::getStoreConfig('oneattribute/general/width'):50,
                'czoomRel' => Mage::helper('oneattribute')->getCloudZoomConfig(true)
            ),
