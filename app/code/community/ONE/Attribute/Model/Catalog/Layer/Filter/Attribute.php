 ...
 */
class ONE_Attribute_Model_Catalog_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute{
    /**
    ...
    {
        if (!Mage::getStoreConfig('oneattribute/general/show3')) return parent::_getItemsData();
        ...
        if ($data === null) {
            ...
            $width = Mage::getStoreConfig('oneattribute/general/width3');
