...
class ONE_Filter_Block_Catalog_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price{
    protected $_hash;
    protected $_maxPrice;
    ...
    public function __construct(){
        parent::__construct();
        if (Mage::helper('onefilter')->isPriceEnable()){
            $this->setTemplate('one/filter/price.phtml');
            $this->_hash = Mage::helper('core')->uniqHash('slider-');
            $this->_filterModelName = 'onefilter/layer_filter_price';
        }
    }
