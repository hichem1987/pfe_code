...
class ONE_RevSlider_Block_Adminhtml_Slide_Video_Form extends Mage_Adminhtml_Block_Widget_Form{
    protected function _prepareForm(){
        ...
        $form->getElement('video_poster')->setRenderer(
            $this->getLayout()->createBlock('oneext/adminhtml_widget_form_element_browser', '', array(
                'element' => $v2
            ))
        );
        ...
        $this->setForm($form);
        $this->setChild('form_after', $this->getLayout()->createBlock('oneext/adminhtml_widget_form_element_dependence')
