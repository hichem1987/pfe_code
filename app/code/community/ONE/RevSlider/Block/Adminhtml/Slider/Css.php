...
class ONE_RevSlider_Block_Adminhtml_Slider_Css extends Mage_Adminhtml_Block_Template{
    public function _construct(){
        parent::_construct();
        $this->setTemplate('one/revslider/css.phtml');
    }
    ...
    public function getCssContent(){
        ...
        if (!$css){
            $file = Mage::getBaseDir().'/js/bakery/revslider/rs-plugin/css/captions.css';
