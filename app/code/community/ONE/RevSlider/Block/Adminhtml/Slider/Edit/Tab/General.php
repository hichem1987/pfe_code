...
class ONE_RevSlider_Block_Adminhtml_Slider_Edit_Tab_General
    ...
    public function _prepareForm(){
        ...
        $fieldset->addField('enable_static_layers', 'select', array(
            'name'      => 'enable_static_layers',
            'label'     => Mage::helper('revslider')->__('Enable Static Layers'),
            'title'     => Mage::helper('revslider')->__('Enable Static Layers'),
            'values'    => $model->getOnOffOptions(),
            'note'      => Mage::helper('revslider')->__('This will enable the static layerss, giving you the option to have layers that stay on the slider on more then one slide')
        ));
