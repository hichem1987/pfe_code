...
class ONE_RevSlider_Block_Adminhtml_Slider_Edit_Tab_Main
    ...
    public function _prepareForm(){
        /* @var $model ONE_RevSlider_Model_Slider */
        ...
        $fieldset->addField('title', 'text', array(
            ...
            'required'  => true,
            'note'      => Mage::helper('revslider')->__('The title of the slider. Example: Awesome Slider')
        ));
        ...
        if (version_compare(Mage::getVersion(), '1.7.0.0') < 0){
            $dependenceElement = $this->getLayout()->createBlock('oneext/adminhtml_widget_form_element_dependence');
        }else{
