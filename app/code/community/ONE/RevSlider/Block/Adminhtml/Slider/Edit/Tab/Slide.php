...
class ONE_RevSlider_Block_Adminhtml_Slider_Edit_Tab_Slide extends Mage_Adminhtml_Block_Widget_Grid{
    protected $_slider;
    ...
    protected function _prepareColumns(){
        ...
        $this->addColumn('slide_order', array(
            ...
            'width'     => '300px',
            'filter'    => false,
            'renderer'  => 'oneext/adminhtml_widget_grid_column_renderer_text'
        ));
    ...
    protected function _prepareLayout(){
        ...
        if ($slider && $slider->getId()){
            ...
            $this->setChild('addSlideButton',
                $this->getLayout()->createBlock('adminhtml/widget_button', null, array(
