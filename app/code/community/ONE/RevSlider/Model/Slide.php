...
class ONE_RevSlider_Model_Slide extends Mage_Core_Model_Abstract{
    ...
    const LOOP_ANIM_1   = 'none';
    const LOOP_ANIM_2   = 'rs-pendulum';
    const LOOP_ANIM_3   = 'rs-slideloop';
    const LOOP_ANIM_4   = 'rs-pulse';
    const LOOP_ANIM_5   = 'rs-wave';
    ...
    public function getLoopAnimationOptions(){
        $options = new Varien_Object(array(
            self::LOOP_ANIM_1   => Mage::helper('revslider')->__('Disabled'),
            self::LOOP_ANIM_2   => Mage::helper('revslider')->__('Pendulum'),
            self::LOOP_ANIM_3   => Mage::helper('revslider')->__('Slideloop'),
            self::LOOP_ANIM_4   => Mage::helper('revslider')->__('Pulse'),
            self::LOOP_ANIM_5   => Mage::helper('revslider')->__('Wave')
        ));
