...
class ONE_Search_Block_Widget extends Mage_Core_Block_Template{
    protected function _construct(){
        parent::_construct();
        if (Mage::getStoreConfigFlag('onesearch/general/enable')){
            $this->setTemplate('one/search/widget.phtml');
        }else{
