 ...
 */
class ONE_Widget_Model_Widget_Source_Mode{
    public function toOptionArray(){
        $modes = array(
            ...
            array('value' => 'id', 'label' => Mage::helper('onewidget')->__('Specified Products')),
            ...
            array('value' => 'upsell', 'label' => Mage::helper('onewidget')->__('Up-sell Products')),
            array('value' => 'crosssell', 'label' => Mage::helper('onewidget')->__('Cross-sell Products')),
