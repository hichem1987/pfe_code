...
class ONE_Widget_Adminhtml_Widget_InstanceController extends Mage_Adminhtml_Controller_Action{
    public function categoriesAction(){
        $selected = $this->getRequest()->getParam('selected', '');
        $chooser = $this->getLayout()
            ->createBlock('onewidget/adminhtml_catalog_category_widget_chooser')
    ...
    public function productsAction(){
        $selected = $this->getRequest()->getParam('selected', '');
        $chooser = $this->getLayout()
            ->createBlock('onewidget/adminhtml_catalog_product_widget_chooser')
            ->setUseMassaction(true)
