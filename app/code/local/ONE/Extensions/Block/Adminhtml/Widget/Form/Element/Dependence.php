 ...
 */
class ONE_Extensions_Block_Adminhtml_Widget_Form_Element_Dependence extends Mage_Adminhtml_Block_Widget_Form_Element_Dependence{
    /**
     ...
     * @return ONE_Extensions_Block_Adminhtml_Widget_Form_Element_Dependence
     */
    ...
    protected function _toHtml()
    {
        ...
        return '<script type="text/javascript"> new ONE.FormElementDependenceController('
