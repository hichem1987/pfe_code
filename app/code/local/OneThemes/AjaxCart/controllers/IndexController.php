...
class OneThemes_AjaxCart_IndexController extends Mage_Checkout_CartController
{
		...
		if($params['isAjax'] == 1){
			...
			try {
				...
				if (!$cart->getQuote()->getHasError()){
					$message = $this->__('Item was successfully added to your Cart.', Mage::helper('core')->htmlEscape($product->getName()));
