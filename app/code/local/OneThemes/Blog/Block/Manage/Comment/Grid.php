...
class OneThemes_Blog_Block_Manage_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            array('onethemes_blog_main' => $collection->getTable('blog/blog')), 'main_table.post_id=onethemes_blog_main.post_id',
            array('onethemes_blog_main.title')
        );
