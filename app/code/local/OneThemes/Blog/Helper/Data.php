...
class OneThemes_Blog_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return Mage::getStoreConfig('blog/blog/enabled') && $this->extensionEnabled('OneThemes_Blog');
    }
    ...
    /**
     * Check is OneThemes_Mobile installed
     *
     * @return bool
     */
    public function isMobileInstalled()
    {
        return $this->isModuleOutputEnabled('OneThemes_Mobile')
            && @class_exists('OneThemes_Mobile_Block_Catalog_Product_List_Toolbar')
        ;
    }
}