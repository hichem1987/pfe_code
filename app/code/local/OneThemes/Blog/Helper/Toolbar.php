...
class OneThemes_Blog_Helper_Toolbar extends Mage_Core_Block_Abstract
{
    public function create($block, $params = array())
    {
        ...
        $block->setChild('onethemes_blog_comments_toolbar', $toolbar);
    }
    ...
    {
        $block = $this->getToolbarParentBlock()->getLayout()->getBlock('onethemes_blog_list_toolbar');
        if (!$block) {
