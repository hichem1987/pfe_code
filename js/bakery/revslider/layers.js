...
RevLayers.prototype = {
    ...
    openCssDialog: function(url, id, title){
        ...
        if (style.value){
            ...
            ONE.MediabrowserUtility.openDialog(url, id, 1000, null, title);
    ...
    openAnimationDialog: function(url, id, title, type){
        ...
        ONE.MediabrowserUtility.openDialog(url, id, null, null, title);
    },
            ...
            switch (this.selectedLayer.params.type){
                case 'image':
                    ...
                    if (addLayerImageUrl){
                        ...
                        ONE.MediabrowserUtility.openDialog(url, 'editLayerImageWindow', null, null, Translator.translate('Add Image'));
                    }
                    break;
                case 'video':
                    ...
                    if (addLayerVideoUrl){
                        ...
                        ONE.MediabrowserUtility.openDialog(url, 'editLayerVideoWindow', null, null, Translator.translate('Add Video'));
                    }
                    break;
            }
        }
                            ...
                            onSuccess: function(transport){
                                try {
                                    ...
                                    if (response.success) {
                                        ...
                                        var text = this.selectedLayer.down('.tp-caption');
                                        if (text) text.addClassName(response.handle);
        ...
        if (data){
            ...
            switch (data.video_type){
                ...
                case 'html5':
                    ...
                    var img = new Element('img', {src:thumb, width:280+'px'});
                    img.setStyle({border:'1px solid #000'});
                    content.insert(img);
                    break;
            }
    ...
    addLayer: function(layer){
        ...
        if (layer.whitespace    == undefined) layer.whitespace = 'normal';
